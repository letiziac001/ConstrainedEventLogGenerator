...
os.makedirs(f'{path}/results_entr', exist_ok=True)
...
for log_name in log_names:
    ...
    df.to_csv(f"{path}/results_entr/entropy_{log_name}.csv", index=False)
    print(f"Saved: {path}/results_entr/entropy_{log_name}.csv")
